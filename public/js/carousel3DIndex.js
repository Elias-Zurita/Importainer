(function($) {
  // Cada llamada de esta función solo es responsable de la función de un carrusel
  ...
  // Encuentra la etiqueta raíz del carrusel a rotar, llama a slide()
  $.fn.hiSlide = function(options) {
      $(this).each(function(index, ele) {
          slide(ele,options);
      });
      // valor devuelto para admitir llamadas en cadena
      return this;
  }
})(jQuery);
